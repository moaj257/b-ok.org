    ...
    selectors: [
      {
        set: [
          ...
          { selector: 'div[title="Publisher"]', attr: [], isAttr: false, keyValue: 'publiser', root: '.resItemBox.resItemBoxBooks', multi: false },
          { selector: '.authors a[itemprop="author"]', attr: [], isAttr: false, keyValue: 'authors', root: '.resItemBox.resItemBoxBooks', multi: true },
